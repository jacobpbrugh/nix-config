...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Jacob Brugh"
    user-mail-address "jacobpbrugh@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/jacob/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/jacob/bin" "/profile/bin" "/Users/jacob/.npm-packages/bin" "/Users/jacob/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
